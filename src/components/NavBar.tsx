...
import { BiSolidBadge, BiSolidMessageRoundedDots } from "react-icons/bi";
  ...
  return (
    <div className="bg-indigo-900 w-100 h-auto flex align-center justify-between">
      ...
      <div className={`w-1/7 m-3 ${key}`}>
        <NavLink to="/messages" className="w-1/7 pt-2 flex">
          <span className="relative ">
            <IoIosNotifications className="text-light w-8 h-8 pt-2" />
          </span>
          <span className="absolute text-danger">
            <BiSolidBadge />
          </span>
        </NavLink>
      </div>
      ...
      <div className="lg:hidden md:hidden pb-2 m-1 sm:flex-col sm:w-100 align-center justify-center">
        ...
        <div
          className={`${menu} flex align-center justify-center text-center w-1/2`}
        >
          {" "}
          <ul className="flex-col">
            <li className=" text-indigo-100">
              <NavLink to="/" className="mr-80 pr-40">
                Home
              </NavLink>
            </li>
            {isAuth ? (
              ...
              <li className="text-indigo-100 ">
                <NavLink to="/login" className="mr-80 pr-40">
                  Login
                </NavLink>
              </li>
            )}
            {isAuth ? (
              ...
              <li className="text-indigo-100">
                <NavLink to="/register" className="mr-80 pr-40">
                  Register
                </NavLink>
              </li>
            )}
            ...
            <li className="text-indigo-100">
              <NavLink to="/about" className="mr-80 pr-40">
                About
              </NavLink>
            </li>
            {isAuth ? (
